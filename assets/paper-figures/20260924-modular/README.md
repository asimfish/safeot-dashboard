# SafeOT-Dual figures — V10 modular refinement (2026-09-24)
...
Figure1 encloses the shared construction and policy update in one dominant module, with subordinate penalty/constraint endpoints. It
...
Figure2 has three major modules: rollout/graph inputs, unified price construction,
and policy update. The graph-price and episode-feedback branches merge inside
the core; GAE has its own direct route and there is one outer rollout loop.

All displayed PNG previews are actual LibreOffice renders of the delivered PPTX.
The two figures contain 512 native leaf objects and no raster artwork. Text,
...
movement and label editing were verified. Main module labels are about 6.3–7.1 pt at 5.5 inches; small axis/qualification
notes are about 5.5–5.6 pt. Formula scripts are smaller. Exact minima are recorded in
