...
independent path, and the updated policy generates the next rollout. Hard graph support is zeroed; the finite on-policy hard-channel penalty does not enforce policy support. The figure
