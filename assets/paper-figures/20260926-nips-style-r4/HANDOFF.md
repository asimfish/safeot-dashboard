...
R3, R2, R1 and all earlier history are unchanged. This branch is a visual candidate only and does not modify the manuscript. PPTX remains the editable source; the SVG/PDF are vector exports.
